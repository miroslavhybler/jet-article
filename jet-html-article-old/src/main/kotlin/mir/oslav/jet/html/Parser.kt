...
import mir.oslav.jet.html.article.normalizedLink
...
internal object Parser {
    ...
    internal fun parseBasicListFromText(
        ...
        return HtmlElementOld.BasicList(
            isOrdered = isOrdered,
            startIndex = startIndex,
            endIndex = endIndex,
            items = items
